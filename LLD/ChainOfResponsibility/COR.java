...
class ThousandHandler extends MoneyHandler {
    ...
    public void dispense(int amount) {
        ...
        if (notesNeeded > 0)
            System.out.println("Dispensing " + notesNeeded + " x 1000 rupee notes.");
...
class FiveHundredHandler extends MoneyHandler {
    ...
    public void dispense(int amount) {
        ...
        if (notesNeeded > 0)
            System.out.println("Dispensing " + notesNeeded + " x 500 rupee notes.");
...
class TwoHundredHandler extends MoneyHandler {
    ...
    public void dispense(int amount) {
        ...
        if (notesNeeded > 0)
            System.out.println("Dispensing " + notesNeeded + " x 200 rupee notes.");
